...
import AddLessonDialog from "../AddLessonDialog/AddLessonDialog";
import { addNewLesson, addNewSection } from "../../api/courseServices";
    ...
    <Box className={styles.sectionContainer}>
          ...
          >
            <Box className={styles.sectionContent}>
              {section.lessons?.map((lesson, index) => (
                <Link
                  to={`/instructor-dashboard/addLessonContent/${lesson.id}`}
                >
      ...
      {openSectionDialog && (
        <AddSectionDialog
          ...
          handleClickOpen={handleClickOpenSectionDialog}
          handleClose={handleCloseSectionDialog}
      ...
      {openLessonDialog && (
        <AddLessonDialog
          ...
          handleClickOpen={handleClickOpenLessonDialog}
